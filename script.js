// ---------- CONFIG ----------
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxkEZOUrS9Vd5EF72N1e2PAfL14sQToscX6EFPSVytVXmm-kxPAr7xTSr_SmMWpJ1Wt/exec";
    ...
    regForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        if (data.result === "success") {
          ...
          formMsg.innerHTML = "✅ Registration successful!<br>Check your email for confirmation.<br>A VJudge link has been included.";
          f.reset();
